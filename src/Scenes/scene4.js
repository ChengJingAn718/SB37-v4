    ...
    function startDangerAniIntro() {
        if (pictureShowingCount < 2) {
            ...
            timerList[5] = setTimeout(() => {
                introAnimal1.current.setUrl('SB_37_Character-Interactive/' + pictureList[0] + '.svg')
                introAnimal.current.setUrl('SB_37_Character-Interactive/' + pictureList[1] + '.svg')

                introAnimal1.current.setPosInfo(pictureInfoList[0])
                introAnimal.current.setPosInfo(pictureInfoList[1])

                if (gameNumber == 3)
                    desertRef.current.setClass('showObject')

                introPanel1.current.setUrl('SB_37_FG/' + backgroundList[0] + '.svg')
                introPanel.current.setUrl('SB_37_FG/' + backgroundList[1] + '.svg')
